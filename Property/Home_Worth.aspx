    ...
    <div id="main-wrap" class="clearfix">
        <div class="main-container bg clearfix ">
            <div style="padding-top: 76.2px;" class="addre-box-header">
                ...
                <h1 id="siteLiveHomePageMainTitle">What's your Home Really Worth ?</h1>
                <h2><span class="line">&nbsp;</span><span id="siteLiveHomePageSmallerTitle1">Home Price are Increases in your Neighbourhood</span><span class="line">&nbsp;</span></h2>
